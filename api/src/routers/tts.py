...
def _cached_audio_is_current(
    ...
    require_speaker_wav: bool = False,
    require_speaker_profiles: bool = False,
) -> bool:
...
async def tts_endpoint(
    ...
    if wav_path.exists() and _cached_audio_is_current(
        wav_path,
        require_speaker_wav=require_speaker_wav,
        require_speaker_profiles=require_speaker_profiles,
    ):
        return {
            "video_id": video_id,
